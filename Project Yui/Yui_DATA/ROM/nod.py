...
while retry==1:
    ...
    if opt not in escape:
        ...
        while day>=32:
            print("There is no month where the day is more than 31 days.")
            day= int(input("Try again (DD): "))

        while day>=31 and month in yday:
                print("This month has only 30")
                day= int(input("Try again (DD): "))

        if month in feb:
            if y1==0:
                while day>=30:
                    print("On leap year February month has 29 day only")
                    day= int(input("Try again (DD): "))
            else:
                while day>=29:
                    print("February month has 28 day only")
                    day= int(input("Try again (DD): "))
        ...
        print("The name of the date is ", name.strftime("%A"))
