...
def slowtype(x, y=0.02,ends=''):
	text=x
	text.replace('|<','\033[4;34;40m')	#LINK
	text.replace('>|','\033[0;37;40m')
	text.replace('|?','\033[0;33;40m')	#DID YOU MEAN...?
	text.replace('?|','\033[0;37;40m')
	text.replace('|!','\033[0;32;40m')	#YES SURE
	text.replace('!|','\033[0;37;40m')
	text.replace('|-','\033[0;30;40m')	#HIDDEN
	text.replace('-|','\033[0;37;40m')
	text.replace('|+','\033[0;37;40m')	#BRIGHT
	text.replace('+|','\033[0;37;40m')
	text.replace('|*','\033[1;37;40m')	#WARNING
	text.replace('*|','\033[0;31;40m')
	text.replace('|+','\033[1;37;43m')
	text.replace('+|','\033[0;37;40m')
